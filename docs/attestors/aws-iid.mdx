...
## Schema
<JSONRenderer url="https://raw.githubusercontent.com/chaosinthecrd/go-witness/attestor-json-schema/schemagen/aws.json" />

The original schema of the AWS Instance Identity attestor is available [here](https://raw.githubusercontent.com/chaosinthecrd/go-witness/attestor-json-schema/schemagen/aws.json).
