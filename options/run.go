...
func (o *ArchivistOptions) AddFlags(cmd *cobra.Command) {
	cmd.Flags().StringVar(&o.Grpc, "archivist-grpc", "", "Archivist grpc server to store attestations")
	cmd.Flags().StringVar(&o.GraphQL, "archivist-graph", "", "Archivist graphql server to retrieve attestations")
}
